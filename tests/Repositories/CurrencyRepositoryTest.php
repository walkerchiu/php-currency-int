...
class CurrencyRepositoryTest extends \Orchestra\Testbench\TestCase
{
    ...
    public function testEnableAndDisable()
    {
        ...
        // Give
        factory(Currency::class)->create(['is_enabled' => 1]);
    ...
    public function testFormTrait()
    {
        ...
        // Name
            ...
            $this->repository->createLangWithoutCheck(['morph_id' => 1, 'morph_type' => Currency::class, 'code' => 'en_us', 'key' => 'name', 'value' => 'Hello']);
            $this->repository->createLangWithoutCheck(['morph_id' => 2, 'morph_type' => Currency::class, 'code' => 'zh_tw', 'key' => 'name', 'value' => '您好']);
            // When
        ...
        // Serial, Identifier
            // Give
            factory(Currency::class)->create(['serial' => '123']);
            factory(Currency::class)->create(['serial' => '124']);
            factory(Currency::class)->create(['serial' => '125', 'is_enabled' => 1]);
            // When
    ...
    public function testAutoComplete()
    {
        ...
        // Give
        factory(Currency::class)->create(['serial' => 'A123', 'is_enabled' => 1]);
        factory(Currency::class)->create(['serial' => 'A124', 'is_enabled' => 1]);
        $this->repository->createLangWithoutCheck(['morph_id' => 1, 'morph_type' => Currency::class, 'code' => 'en_us', 'key' => 'name', 'value' => 'Hello']);
        $this->repository->createLangWithoutCheck(['morph_id' => 1, 'morph_type' => Currency::class, 'code' => 'en_us', 'key' => 'description', 'value' => 'Good Morning!']);
        $this->repository->createLangWithoutCheck(['morph_id' => 1, 'morph_type' => Currency::class, 'code' => 'en_us', 'key' => 'name', 'value' => 'Hello World']);
        $this->repository->createLangWithoutCheck(['morph_id' => 1, 'morph_type' => Currency::class, 'code' => 'zh_tw', 'key' => 'name', 'value' => '您好']);
        $this->repository->createLangWithoutCheck(['morph_id' => 1, 'morph_type' => Currency::class, 'code' => 'zh_tw', 'key' => 'name', 'value' => '早安']);
        $this->repository->createLangWithoutCheck(['morph_id' => 2, 'morph_type' => Currency::class, 'code' => 'en_us', 'key' => 'name', 'value' => 'Bye']);
